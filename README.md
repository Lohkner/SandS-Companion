...
Puedes acceder a la última versión estable directamente desde el navegador: (https://github.com/Lohkner)

Opción B: Instalación Local
Descarga el repositorio.
Abre el archivo index.html en cualquier navegador moderno (Chrome, Firefox, Edge).
¡Listo! No requiere instalación de servidores ni dependencias.
